...
const schema = object({
    email: string().required("Please enter password").required("Please enter valid email"),
                    ...
                    <form onSubmit={formik.handleSubmit}>
                        <div>
                            ...
                            <input type='text'
                                ...
                                <span className='text-purple-600' >{formik.errors.name}</span>
                        </div>
                        <div>
                            ...
                            <input type='email'
                                ...
                                className='border border-purple-500'
                                onChange={formik.handleChange} />
                            <span className='text-purple-600' >{formik.errors.email}</span>
                        </div>
                        <div>
                            ...
                            <input type='password'
                                ...
                                className='border border-purple-500'
                                onChange={formik.handleChange} />
                                <span className='text-purple-600' >{formik.errors.password   }</span>
                        </div>
                        <div>
